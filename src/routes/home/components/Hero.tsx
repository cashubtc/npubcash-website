      ...
      <div className="relative group">
        ...
        <div className="relative bg-gradient-to-tr from-purple-500 to-pink-500 p-0.5 rounded">
          <div className="bg-zinc-900 p-4">
            <p className="bg-gradient-to-tr from-purple-500 to-pink-500 text-transparent bg-clip-text tmd:text-2xl text-center font-bold ">{`<npub|user>@cashu-address.com`}</p>
          </div>
        </div>
      </div>
